...
export default function MainOff({ codigoPromocional }: MainOffProps) {
    ...
    return (
        <div className="flex-1 rounded-2xl overflow-x-hidden flex shadow-xl min-w-[28rem] min-h-[18rem] max-w-md hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 ease-in-out">
            {/* Caja izquierda */}
            <div className="bg-gradient-to-br from-[var(--rose)] to-[var(--rose-400)] p-5 w-3/5 flex flex-col justify-between text-[var(--white)] relative overflow-hidden">

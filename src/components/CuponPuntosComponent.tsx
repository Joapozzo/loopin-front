...
const CuponPuntosComponent = () => {
    ...
    const handleSubmit = async (e?: React.FormEvent | React.KeyboardEvent) => {
        ...
        try {
            ...
            // Asumir que la respuesta incluye los datos de éxito
            setSuccessData(response.data);
            setShowSuccess(true);
            setErrorMessage('');

            // Cerrar modal después de 3 segundos para que vea la info
            // setTimeout(() => {
            //     closeModal();
            // }, 3000);

        } catch (error: any) {
            // Manejar tanto error.message como error.detail
    ...
    return (
        <>
            ...
            {isModalOpen && (
                <div
                    className="fixed inset-0 z-50 flex items-center justify-center transition-all duration-300 backdrop-blur-sm bg-black/60"
                    onClick={closeModal}
                >
                    <div
...
export default CuponPuntosComponent;
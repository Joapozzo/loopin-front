...
export const useCodigoGenerado = (
    ...
    // ✅ EFECTO CORREGIDO: Refetch códigos promocionales cuando cambien neg_id o suc_id
    useEffect(() => {
        if (enableCodigosPromocionales && neg_id && suc_id) {
            refetchPromocionales();
        }
    }, [neg_id, suc_id, enableCodigosPromocionales]); // ✅ SIN refetchPromocionales en dependencias
